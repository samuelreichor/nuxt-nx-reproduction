...
/* 
  Requirements:
  - should still run if one publication fails 
  - should still work as expected if new package get added
  - should automatically add changelogs and all versions
  - should automatically detect version
*/
